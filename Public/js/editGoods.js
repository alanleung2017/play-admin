...
$(function(){
        ...
        oFile.Init = function(ctrlName, uploadUrl) {
            ...
            $("#goods_photo_url").on("fileuploaded", function (event, data, previewId, index) {
                ...
                if(myResponse.status == 1){
                    $('#goodsForm').append('<input type="hidden" name="item_photo_id" value="'+myResponse.content+'"/>');
                    $('#goods_photo').attr('src',myResponse.photo_url);
                    $("#myModal").modal("hide");
                }else{
                    alert(myResponse.content);
                }
    ...
    oFileInput.Init("goods_photo_url", url+"/uploadGoodsPic");
