...
$(function(){
    ...
    var FileInput = function () {
        ...
        oFile.Init = function(ctrlName, uploadUrl) {
            ...
            //导入文件上传完成之后的事件
            $("#shop_photo_url").on("fileuploaded", function (event, data, previewId, index) {
                ...
                if(myResponse.status == 1){
                    ...
                    $('#shop_photo').attr('src',myResponse.photo_url);
                    $("#myModal").modal("hide");
                }else{
                    alert(myResponse.content);
                }
    ...
    oFileInput.Init("shop_photo_url", url+"/uploadShopPic");
    //上传商店图片结束
...
//                        alert(data.msg);
    ...
    //初始化fileinput
    var carouselFileInput1 = new FileInputCarousel();
    carouselFileInput1.Init("carousel_photo", url+"/uploadMany");

    /*var carouselFileInput2= new FileInputCarousel();
    carouselFileInput2.Init("carousel_modal2", url+"/uploadMany","carousel_photo2","myModal3");

    var carouselFileInput3= new FileInputCarousel();
    carouselFileInput3.Init("carousel_modal3", url+"/uploadMany","carousel_photo3","myModal4");*/
    //上传轮播图片结束
